...
const Logo = () => {
    ...
    return (
        <div className="logo-container" ref={bgRef}>
            <img src={myLogo} alt="Logo" className="solid-logo" ref={solidRef} />
            <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 284 369" width="403" height="524">
